...
from iftracer.sdk.utils import is_notebook
from iftracer.sdk.utils.package_check import is_package_installed
from typing import Dict, Optional, Set


TRACER_NAME = "iftracer.tracer"
EXCLUDED_URLS = """
    iam.cloud.ibm.com,
...
class TracerWrapper(object):
    ...
    def verify_initialized(cls) -> bool:
        ...
        print(
            Fore.RED
            + "Warning: Iftracer not initialized, make sure you call Iftracer.init()"
        )
        print(Fore.RESET)
        return False
